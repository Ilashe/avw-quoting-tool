...
export const PENDING_PART_BADGES: Record<string, { tag: string; note: string }> = {
  ...
  'TR4': { tag: 'FLAG', note: 'Flagged — bundle logic not finalized yet' },
  'TR4-EL': { tag: 'FLAG', note: 'Flagged — bundle logic not finalized yet' },
  'OT2-WC3-EL': { tag: 'FLAG', note: 'Flagged — bundle logic not finalized yet' },
